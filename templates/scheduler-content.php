...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    ...
    <?php /* Loop is customized inside file "vertycal-loop-table.php"
        */ 
        require_once ( plugin_dir_path( __FILE__ ) . 'vertycal-loop-table.php' ); 
    ?>
    <?php 
    $vt_query = new WP_Query($args); ?>
    ...
    <tr><th class="scheduled-item-prime"><small>
        ...
        <th class="scheduled-item-first"><small>
            <?php print( esc_html( vertycal_display_thead() ) ); ?></small></th>
    ...
    <tbody>
        ...
        <?php
        while ( $vt_query->have_posts() ) : $vt_query->the_post();
            ...
            <tr class="scheduled-item">
                ...
                <div class="vrtcl-inner">
                    ...
                    <div class="vrtcl_excerpt">
                        <a class="xoox" href="#popup<?php echo esc_attr( $postid ) ?>">
                <span class="disc"></span><?php trim( wp_strip_all_tags( the_excerpt() ) ); ?></a>
                    </div>

                    <div id="popup<?php echo esc_attr( $postid ) ?>" class="overlay">
	                    <div class="popup">
        ...
        <div class="inner-link">
            ...
            <p class="author-is"><span><?php echo esc_html( vertycal_return_author_initials() ); ?> </span>
            ...
            <table id="Paginate" class="calendar-main"><tbody>
                <tr>
                    <td class="td-pagination">
                        ...
                        <?php echo wp_kses_post( vertycal_pagination_schedule() ); ?>
